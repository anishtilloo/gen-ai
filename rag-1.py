...
while True:
    ...
    Output: {{ "step": "observe", "content": "Based on my context the user is asking fs module from node js" }}
    Output: {{ "step": "generate", "content": "The fs module in Node.js provides file I/O operations. It offers simple wrappers around standard POSIX functions, allowing you to interact with the file system. To use the fs module, you need to require it using require('fs'). All the methods in the fs module have both asynchronous and synchronous forms, giving you flexibility in how you handle file operations." }}
